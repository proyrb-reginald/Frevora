...
typedef enum {
    BTM_FreqSelect_15_625MS =
        0x00U
        << BTM_CON_BTMFS_Pos, /*!< BTM Interruption: Happens every 15.625MS */
    BTM_FreqSelect_31_25MS =
        0x01U
        << BTM_CON_BTMFS_Pos, /*!< BTM Interruption: Happens every 31.25MS   */
    BTM_FreqSelect_62_5MS =
        0x02U
        << BTM_CON_BTMFS_Pos, /*!< BTM Interruption: Happens every 62.5MS    */
    BTM_FreqSelect_125MS =
        0x03U
        << BTM_CON_BTMFS_Pos, /*!< BTM Interruption: Happens every 125MS    */
    BTM_FreqSelect_250MS =
        0x04U
        << BTM_CON_BTMFS_Pos, /*!< BTM Interruption: Happens every 250MS    */
    BTM_FreqSelect_500MS =
        0x05U
        << BTM_CON_BTMFS_Pos, /*!< BTM Interruption: Happens every 500MS    */
    BTM_FreqSelect_1S =
...
#define IS_BTM_FREQSELECT(SELECT)                                              \
    (((SELECT) == BTM_FreqSelect_15_625MS) ||                                  \
     ((SELECT) == BTM_FreqSelect_31_25MS) ||                                   \
     ((SELECT) == BTM_FreqSelect_62_5MS) ||                                    \
     ((SELECT) == BTM_FreqSelect_125MS) ||                                     \
     ((SELECT) == BTM_FreqSelect_250MS) ||                                     \
     ((SELECT) == BTM_FreqSelect_500MS) || ((SELECT) == BTM_FreqSelect_1S) ||  \
     ((SELECT) == BTM_FreqSelect_2S) || ((SELECT) == BTM_FreqSelect_4S) ||     \
     ((SELECT) == BTM_FreqSelect_8S) || ((SELECT) == BTM_FreqSelect_16S) ||    \
...
#define IS_BTM_IT(IT)                                                          \
    ((((IT) & (uint8_t)0xFE) == 0x00) && ((IT) != (uint8_t)0x00))
/**
 * @}
 */
