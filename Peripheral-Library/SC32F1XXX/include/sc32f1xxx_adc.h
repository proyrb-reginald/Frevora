...
typedef enum {
    ...
    ADC_Prescaler_3CLOCK =
        (uint32_t)(0x04 << ADC_CON_LOWSP_Pos), /*!<The sampling time is 3 APB2
                                                  clocks */
    ADC_Prescaler_6CLOCK =
        (uint32_t)(0x05 << ADC_CON_LOWSP_Pos), /*!<The sampling time is 6 APB2
                                                  clocks */
    ADC_Prescaler_16CLOCK =
        (uint32_t)(0x06 << ADC_CON_LOWSP_Pos), /*!<The sampling time is 16 APB2
                                                  clocks */
    ADC_Prescaler_32CLOCK =
        (uint32_t)(0x07 << ADC_CON_LOWSP_Pos), /*!<The sampling time is 32 APB2
                                                  clocks */
#elif defined(SC32f15xx)
    ADC_Prescaler_3CLOCK =
        (uint32_t)(0x00 << ADC_CON_LOWSP_Pos), /* The sampling time is 3   APB2
                                                  clocks */
    ADC_Prescaler_6CLOCK =
        (uint32_t)(0x01 << ADC_CON_LOWSP_Pos), /* The sampling time is 6   APB2
                                                  clocks */
    ADC_Prescaler_9CLOCK =
        (uint32_t)(0x02 << ADC_CON_LOWSP_Pos), /* The sampling time is 9   APB2
                                                  clocks */
    ADC_Prescaler_15CLOCK =
        (uint32_t)(0x03 << ADC_CON_LOWSP_Pos), /* The sampling time is 15  APB2
                                                  clocks */
    ADC_Prescaler_30CLOCK =
        (uint32_t)(0x04 << ADC_CON_LOWSP_Pos), /* The sampling time is 30  APB2
                                                  clocks */
    ADC_Prescaler_60CLOCK =
        (uint32_t)(0x05 << ADC_CON_LOWSP_Pos), /* The sampling time is 60  APB2
                                                  clocks */
    ADC_Prescaler_120CLOCK =
        (uint32_t)(0x06 << ADC_CON_LOWSP_Pos), /* The sampling time is 120 APB2
                                                  clocks */
    ADC_Prescaler_480CLOCK =
        (uint32_t)(0x07 << ADC_CON_LOWSP_Pos), /* The sampling time is 480 APB2
                                                  clocks */
#endif
...
#elif defined(SC32f11xx)
#    define IS_ADC_CHANNEL(CHANNEL)                                            \
        ((CHANNEL) <= ADC_Channel_17 || (CHANNEL) == ADC_Channel_PGA ||        \
...
#    define IS_ADC_Thresholds_Channel(Channel)                                 \
        ((Channel | ADC_Thresholds_Channel_All) != 0)
...
typedef enum {
    ...
    ADC_VREF_VDD =
        (uint32_t)(0x00
                   << ADC_CON_VREFS_Pos), /*!< ADC reference voltage is VDD */
    ADC_VREF_2_048V =
        (uint32_t)(0x01 << ADC_CON_VREFS_Pos), /*!< ADC reference voltage
                                                  is 2.048V */
    ADC_VREF_1_024V =
        (uint32_t)(0x02 << ADC_CON_VREFS_Pos), /*!< ADC reference voltage
                                                  is 1.024V */
    ADC_VREF_2_4V =
        (uint32_t)(0x03
                   << ADC_CON_VREFS_Pos) /*!< ADC reference voltage is 2.4V   */
#elif defined(SC32f15xx)
    ADC_RefSource_VDD =
        (uint32_t)(0x00
                   << ADC_CON_REFSEL_Pos), /*!< ADC reference voltage is VDD */
    ADC_RefSource_VREF =
        (uint32_t)(0x01
                   << ADC_CON_REFSEL_Pos), /*!< ADC reference voltage is Vref */
#endif
} ADC_VREF_TypeDef;
#if defined(SC32f10xx) || defined(SC32f11xx) || defined(SC32f12xx)
...
#if defined(SC32f10xx) || defined(SC32f11xx) || defined(SC32f12xx)
    ADC_IT_ADCIF =
        (uint16_t)ADC_CON_INTEN, /*!< ADC Interrupt: ADC  Interrupt */
#elif defined(SC32f15xx)
    ADC_IT_INTEN = (uint16_t)ADC_IDE_INTEN, /*!< ADC interrupt request Flag */
    ADC_IT_EOCIE =
        (uint16_t)ADC_IDE_EOCIE, /*!< ADC sequence 0 sampling + conversion
                                    complete interrupt Flag */
    ADC_IT_EOSIE0 =
        (uint16_t)ADC_IDE_EOSIE0, /*!< ADC sequence 0 sampling + conversion
                                     complete interrupt Flag */
    ADC_IT_UPTHIE =
        (uint16_t)ADC_IDE_UPTHIE, /*!< ADC upper threshold overflow Flag */
    ADC_IT_LOWTHIE =
        (uint16_t)ADC_IDE_LOWTHIE, /*!< ADC lower threshold overflow Flag */
#endif
} ADC_IT_TypeDef;
...
typedef enum {
    ...
    ADC_Flag_EOSIF0 =
        (uint8_t)ADC_STS_EOSIF0, /*!< ADC sequence 0 sampling + conversion
                                    complete interrupt Flag */
    ADC_Flag_BUSY = (uint8_t)ADC_STS_BUSY, /*!< ADC busy Flag */
    ADC_Flag_UPTHIF =
        (uint8_t)ADC_STS_UPTHIF, /*!< ADC upper threshold overflow Flag */
    ADC_Flag_LOWTHIF =
        (uint8_t)ADC_STS_LOWTHIF, /*!< ADC lower threshold overflow Flag */
...
typedef struct
{
    uint32_t ADC_Prescaler; /*!<  Specifies sampling time of ADC.
                                                                  This parameter
                               can be a value of @ref ADC_Prescaler_TypeDef */

    uint32_t ADC_EAIN; /*!< Specifies Input channel of ADC.
                                                                    This
                          parameter can be a value of @ref ADC_EAIN_Typedef */

    uint32_t ADC_VREF; /*!<  Specifies reference voltage of ADC.
                                                                    This
                          parameter can be a value of @ref ADC_VREF_TypeDef */

    uint16_t
        ADC_ConvMode; /*!< Specifies ADC work conversion mode.
                                                               This parameter
                         can be a value of @ref ADC_ConvMode_TypeDef */
} ADC_InitTypeDef;
/**
 * @}
 */
