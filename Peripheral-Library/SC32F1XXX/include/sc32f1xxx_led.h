...
typedef enum {
    LED_FrameFre_A32Hz =
        (uint32_t)((0x00U << DDR_CON_DDRCK_Pos) |
                   DDR_CON_TYPE), /*!< The LED/LED frame frequency of typeA is
                                     32Hz */
    LED_FrameFre_A64Hz =
    ...
    LED_FrameFre_A128Hz =
        (uint32_t)((0x02U << DDR_CON_DDRCK_Pos) |
                   DDR_CON_TYPE), /*!< The LED/LED frame frequency of typeA is
                                     128Hz */
    LED_FrameFre_B64Hz =
        (uint32_t)(0x00U << DDR_CON_DDRCK_Pos), /*!< The LED/LED frame frequency
                                                   of typeB is 64Hz */
    LED_FrameFre_B128Hz =
        (uint32_t)(0x01U << DDR_CON_DDRCK_Pos), /*!< The LED/LED frame frequency
                                                   of typeB is 128Hz*/
    LED_FrameFre_B256Hz =
        (uint32_t)(0x02U << DDR_CON_DDRCK_Pos), /*!< The LED/LED frame frequency
                                                   of typeB is 256Hz*/
    ...
    LED_FrameFre_BCustom =
        (uint32_t)(DDR_CON_TRIMODE), /*!< The LED/LED frame frequency of typeB
                                        is customized*/
} LED_FrameFre_TypeDef;

#define IS_LED_FRAMEFRE(FRAMEFRE)                                              \
    (((FRAMEFRE) == LED_FrameFre_A32Hz) ||                                     \
...
typedef enum {
    LED_Duty_1_8 =
        (uint32_t)(0x00U
                   << DDR_CFG_DUTY_Pos), /*!< LED/LED display duty cycle: 1/8 */
    LED_Duty_1_6 =
        (uint32_t)(0x01U
                   << DDR_CFG_DUTY_Pos), /*!< LED/LED display duty cycle: 1/6 */
    LED_Duty_1_5 =
        (uint32_t)(0x02U
                   << DDR_CFG_DUTY_Pos), /*!< LED/LED display duty cycle: 1/5 */
    LED_Duty_1_4_SEG0_27COM4_7 =
        (uint32_t)(0x03U
                   << DDR_CFG_DUTY_Pos), /*!< LED/LED display duty cycle: 1/4 */
