...
#    define __MPU_PRESENT                                                      \
        1U /*!< Coretex Mo+  provides an MPU                  */
#    define __VTOR_PRESENT                                                     \
        1U /*!< Vector  Table  Register supported             */
#    define __NVIC_PRIO_BITS                                                   \
        2U /*!< SC32F12XX uses 2 Bits for the Priority Levels */
...
#        define LXT_VALUE                                                      \
            ((uint32_t)32768) /*!< Default value of the External oscillator in \
                                 Hz */
#    endif                    /* LXT_VALUE */
#    if !defined(HXT_VALUE)
#        define HXT_VALUE                                                      \
            ((uint32_t)16000000) /*!< Default value of the External oscillator \
                                    in Hz */
#    endif                       /* HXT_VALUE */
#    if !defined(HIRC_VALUE)
#        define HIRC_VALUE                                                     \
            ((uint32_t)64000000) /*!< Default value of the External oscillator \
                                    in Hz */
#    endif                       /* HIRC_VALUE */
#    if !defined(LIRC_VALUE)
#        define LIRC_VALUE                                                     \
            ((uint32_t)32000) /*!< Default value of the External oscillator in \
                                 Hz */
#    endif                    /* LIRC_VALUE */
/**
 * @brief SC32F12XX Interrupt Number Definition, according to the selected
...
{
    __IO uint32_t
        APB0_CFG; /*!< APB0 Config register,      Address offset: 0x00 */
    __IO uint32_t
        APB0_RST; /*!< APB0 Reset register,       Address offset: 0x04 */
} RCCAPB0_TypeDef;
...
{
    __IO uint32_t
        APB1_CFG; /*!< APB1 Config register,      Address offset: 0x00 */
    __IO uint32_t
        APB1_RST; /*!< APB1 Reset register,       Address offset: 0x04 */
} RCCAPB1_TypeDef;
...
{
    __IO uint32_t
        APB2_CFG; /*!< APB2 Config register,      Address offset: 0x00 */
    __IO uint32_t
        APB2_RST; /*!< APB2 Reset register,       Address offset: 0x04 */
} RCCAPB2_TypeDef;
 ...
 */
/**
 * @brief UART0-1 for APB0,UART2 for APB1,UART3 for APB2,UART0/2/3 Peripheral
 * offset =0x20,UART1 Peripheral offset=0x80
 */
typedef struct
{
    __IO uint32_t UART_CON;  /*!< UART Config register,                  Address
                                offset: 0x00 */
    __IO uint32_t UART_STS;  /*!< UART Status register,                  Address
                                offset: 0x04 */
    __IO uint32_t UART_BAUD; /*!< UART BaudRate register,                Address
                                offset: 0x08 */
    __IO uint32_t UART_DATA; /*!< UART Data register,                    Address
                                offset: 0x0C */
    __IO uint32_t UART_IDE;  /*!< UART Interrupt /Dma Enable register,   Address
                                offset: 0x10 */
} UART_TypeDef;
...
typedef struct
{
    __IO uint32_t SPI_CON;  /*!< SPI Control register,                 Address
                               offset: 0x00 */
    __IO uint32_t SPI_STS;  /*!< SPI Status register,                  Address
                               offset: 0x04 */
    __IO uint32_t RESERVED; /*!< Reserved,                             Address
                               offset: 0x08 */
    __IO uint32_t SPI_DATA; /*!< SPI Data register,                    Address
                               offset: 0x0C */
    __IO uint32_t SPI_IDE;  /*!< SPI Interrupt /Dma Enable register,   Address
                               offset: 0x10 */
...
typedef struct
{
    __IO uint32_t TWI_CON;  /*!< TWI Config register,                  Address
                               offset: 0x00 */
    __IO uint32_t TWI_STS;  /*!< TWI Status register,                  Address
                               offset: 0x04 */
    __IO uint32_t TWI_ADD;  /*!< TWI Adress register,                  Address
                               offset: 0x08 */
    __IO uint32_t TWI_DATA; /*!< TWI Data register,                    Address
                               offset: 0x0C */
    __IO uint32_t TWI_IDE;  /*!< TWI Interrupt /Dma Enable register,   Address
                               offset: 0x10 */
} TWI_TypeDef;

/**
 * @brief TIEMR0123 for APB0,TIEMR4567 for APB1, Peripheral
 * offset=0x100+0x40*n(n=0,1,2,3)
 */
typedef struct
{
    __IO uint32_t TIM_CON; /*!< TCON register,                         Address
                              offset: 0x00 */
    __IO uint32_t TIM_CNT; /*!< TCNT register,                         Address
                              offset: 0x04 */
    __IO uint32_t TIM_RLD; /*!< TIMER ReLoad register,                 Address
                              offset: 0x08 */
    __IO uint32_t TIM_STS; /*!< TIMER Status register,                 Address
                              offset: 0x0C */
    __IO uint32_t TIM_PDTA_RCAP; /*!< TIMER Rise Caputre Key register, Address
                                    offset: 0x10 */
    __IO uint32_t TIM_PDTB_FCAP; /*!< TIMER fall Caputre register, Address
                                    offset: 0x14 */
    __IO uint32_t TIM_IDE; /*!< TIMER Interrupt /Dma Enable register,  Address
                              offset: 0x18 */
} TIM_TypeDef;
...
typedef struct
{
    ...
    __IO uint32_t PWM_FLT; /*!< PWM FaiLure detection register, Address offset:
                              0x14 */
    __IO uint32_t PWM_CYCLE;   /*!< PWM Cycles register,   Address offset: 0x18 */
    __IO uint32_t RESERVED[5]; /*!< Reserved, Address offset: 0x1C */
    __IO uint32_t PWM_DT[8];   /*!< PWM Duty register,@PWM0 PWM_DT[8] is Valied,
                                  Address offset: 0x30 */
} PWM_TypeDef;
/**
...
typedef struct
{
    ...
    __IO uint32_t
        LEDPWM_DFR; /*!< LEDPWM Dead space register, Address offset: 0x10 */
    __IO uint32_t LEDPWM_FLT; /*!< LEDPWM FaiLure detection register, Address
                                 offset: 0x14 */
    __IO uint32_t
        LEDPWM_CYCLE; /*!< LEDPWM Cycles register, Address offset: 0x18 */
    __IO uint32_t RESERVED[5];   /*!< Reserved,   Address offset: 0x1C~0x2C */
    __IO uint32_t LEDPWM_DT[32]; /*!< LEDPWM Duty register,@LEDPWM LEDPWM_DT[31]
                                    is Valied,  Address offset: 0x30 */
} LEDPWM_TypeDef;
/**
...
{
    __IO uint32_t
        BTM_CON; /*!< ADC Control register,      Address offset: 0x00 */
    __IO uint32_t
        BTM_STS; /*!< ADC Status register,       Address offset: 0x04 */
} BTM_TypeDef;
...
{
    __IO uint32_t
        ADC_CON; /*!< ADC Control register,      Address offset: 0x00 */
    __IO uint32_t
        ADC_STS; /*!< ADC Status register,       Address offset: 0x04 */
    __IO uint32_t
        ADC_VALUE; /*!< ADC Value register,        Address offset: 0x08 */
    __IO uint32_t
        ADC_CFG; /*!< ADC Config register,       Address offset: 0x0C */
} ADC_TypeDef;
...
{
    __IO uint32_t
        OP_CON; /*!< OP Control register,       Address offset: 0x00 */
} OP_TypeDef;
...
{
    __IO uint32_t
        TK_CHN0; /*!< TK Channel register0,        Address offset: 0x00 */
    __IO uint32_t
        TK_CHN1; /*!< TK Channel register1,        Address offset: 0x04 */
    __IO uint32_t
        RESERVED0; /*!< Reserved0,                   Address offset: 0x08 */
    __IO uint32_t
        TK_CON; /*!< TK Control register,         Address offset: 0x0C */
    __IO uint32_t
        TK_CFG; /*!< TK Config register,          Address offset: 0x10 */
    __IO uint32_t
        RESERVED1; /*!< Reserved1,                   Address offset: 0x14 */
    __IO uint32_t
        TK_CNT; /*!< TK RawData register,         Address offset: 0x18 */
    __IO uint32_t
        TK_TM; /*!< TK TM register,              Address offset: 0x1C */
} TK_TypeDef;
...
typedef struct
{
    ...
    __IO uint32_t
        DDR_CFG; /*!< Display Drive Config register,    Address offset: 0x04 */
    __IO uint32_t
        SEG_EN; /*!< Segment IO Enable register,        Address offset: 0x08 */
    __IO uint32_t RESERVED0; /*!< Reserved0,                         Address
                                offset: 0x0C */
    __IO uint32_t
        COM_EN; /*!< COM IO Enable register register,   Address offset: 0x10 */
...
{
    __IO uint32_t
        PIN; /*!< GPIOA,B,C register,                   Address offset: 0x00 */
    __IO uint32_t RESERVED0[7]; /*!< Reserved, Address offset: 0x04 */
    __IO uint32_t PXCON; /*!< GPIO port Control register,           Address
                            offset: 0x20 */
    __IO uint32_t RESERVED1[7]; /*!< Reserved, Address offset: 0x24 */
    __IO uint32_t
        PXPH; /*!< GPIO port pull-up/pull-down register, Address offset: 0x40 */
    __IO uint32_t RESERVED2[7]; /*!< Reserved, Address offset: 0x44 */
    __IO uint32_t PXLEV; /*!< GPIO port Level register,             Address
                            offset: 0x60 */
} GPIO_TypeDef;
...
typedef struct
{
    __IO uint8_t PIN_BIT[16]; /*!< GPIOA,B,C Bit register,              Address
                                 offset: 0x00 */
    __IO uint8_t PIN_XR[16];  /*!< GPIOA,B,C Bit register,              Address
                                 offset: 0x20 */
} GPIO_BIT_TypeDef;
...
typedef struct
{
    __IO uint32_t INTF_IE; /*!< INT Fall edge Enable register,           Address
                              offset: 0x00 */
    __IO uint32_t RESERVED0[7]; /*!< Reserved, Address offset: 0x04 */
    __IO uint32_t INTR_IE; /*!< INT Rise edge Enable register register,  Address
                              offset: 0x20 */
    __IO uint32_t RESERVED1[7]; /*!< Reserved, Address offset: 0x24 */
    __IO uint32_t INT_SEL0; /*!< INT0-7 Port Select register, Address offset:
                               0x40 */
    __IO uint32_t RESERVED2[7]; /*!< Reserved, Address offset: 0x44 */
    __IO uint32_t INT_SEL1; /*!< INT8-15 Port Select register, Address offset:
                               0x60 */
    __IO uint32_t RESERVED3[7]; /*!< Reserved, Address offset: 0x64 */
    __IO uint32_t INTF_CON;     /*!< INT Fall Control  register,     Address offset:
                                   0x80 */
...
{
    __IO uint32_t
        RESERVED0[3]; /*!< Reserved,                     Address offset: 0x00 */
    __IO uint32_t
        WDT_CON; /*!< WDT Control register,         Address offset: 0x0C */
    __IO uint32_t
        WDT_CFG; /*!< WDT Config register,          Address offset: 0x10 */
} WDT_TypeDef;
...
typedef struct
{
    ...
    __IO uint32_t
        CRC_CON; /*!< CRC Config register,      Address offset: 0x04 */
    __IO uint32_t
        CRC_INT; /*!< CRC Inital register,      Address offset: 0x08 */
    __IO uint32_t
        CRC_POL; /*!< CRC Poly  register,       Address offset: 0x0C */
} CRC_TypeDef;
...
{
    __IO uint32_t
        AHB_CFG; /*!< AHB Config register,      Address offset: 0x00 */
    __IO uint32_t
        AHB_RST; /*!< AHB Reset register,       Address offset: 0x04 */
} RCCAHB_TypeDef;
...
{
    __IO uint32_t
        RCC_KEY; /*!< RCC KEY register,          Address offset: 0x0C */
    __IO uint32_t
        RESERVED0; /*!< Reserved0,                 Address offset: 0x10 */
    __IO uint32_t
        RCC_CFG0; /*!< RCC Config0 register,      Address offset: 0x14 */
    __IO uint32_t
        RCC_CFG1; /*!< RCC Config1 register,      Address offset: 0x18 */
    __IO uint32_t
        RESERVED1; /*!< Reserved1,                 Address offset: 0x1C */
    __IO uint32_t
        RCC_STS; /*!< RCC Status  register,      Address offset: 0x20 */
    __IO uint32_t
        RESERVED2; /*!< Reserved2,                 Address offset: 0x24 */
    __IO uint32_t
        SYST_CALIB; /*!< RCC Calib  register,       Address offset: 0x28 */
    __IO uint32_t
        NMI_CFG; /*!< NMI register,              Address offset: 0x2C */
} RCC_TypeDef;
...
typedef struct
{
    __IO uint32_t DMA_SADR; /*!< DMA Source Adress register,            Address
                               offset: 0x00 */
    __IO uint32_t DMA_DADR; /*!< DMA Destination Adress register,       Address
                               offset: 0x04 */
    __IO uint32_t DMA_CFG;  /*!< DMA Config register,                   Address
                               offset: 0x08 */
    __IO uint32_t DMA_CNT;  /*!< DMA Count  register,                   Address
                               offset: 0x0C */
    __IO uint32_t DMA_STS;  /*!< DMA Status register,                   Address
                               offset: 0x10 */
} DMA_TypeDef;
...
#    define SRAM_SIZE_MAX                                                      \
        (0x00004000UL) /*!< maximum SRAM size (up to 16 KBytes) */
