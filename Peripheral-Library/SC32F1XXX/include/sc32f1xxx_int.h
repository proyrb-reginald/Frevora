...
#define IS_INT_MODE(MODE)                                                      \
    (((MODE) == INT_Mode_Interrupt) || ((MODE) == INT_Mode_Event))
...
typedef enum {
    ...
    INT_Trigger_Rising =
        (uint16_t)0x01, /*!< INT Interrupt: Rising edge capture */
    INT_Trigger_Falling =
        (uint16_t)0x02, /*!< INT Interrupt: Falling edge capture */
...
#define IS_INT_IT(IT)                                                          \
    (((IT) == INT_IT_Null) || ((IT) == INT_IT_Rising) ||                       \
     ((IT) == INT_IT_Rising) || ((IT) == INT_IT_Rising_Falling))
/**
 * @}
 */
...
#define IS_INT_FLAG(FLAG)                                                      \
    (((FLAG) == INT_Flag_Rising) || ((FLAG) == INT_Flag_Falling))
/**
 * @}
 */
...
{
    uint16_t
        INT_Channel; /*!<  Specifies the INT channel.
