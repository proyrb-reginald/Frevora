...
typedef enum {
    DMA_State_IDLE =
        ((uint32_t)0x00U << DMA_STS_STATUS_Pos), /*!< DMA idle state */
    DMA_State_SOURCE = ((uint32_t)0x01U
                        << DMA_STS_STATUS_Pos), /*!< DMA write source address */
    DMA_State_BUSY =
        ((uint32_t)0x02U
    ...
    DMA_State_DESTINATION =
        ((uint32_t)0x03U
         << DMA_STS_STATUS_Pos), /*!< DMA write destination address */
    DMA_State_HANG =
        ((uint32_t)0x04U << DMA_STS_STATUS_Pos), /*!< DMA Hang state */
    DMA_State_PAUSE =
        ((uint32_t)0x05U << DMA_STS_STATUS_Pos), /*!< DMA Pause state */
    DMA_State_BURST =
        ((uint32_t)0x06U << DMA_STS_STATUS_Pos), /*!< DMA Burst transmission */
    DMA_State_STOP =
        ((uint32_t)0x07U << DMA_STS_STATUS_Pos), /*!< DMA Stop state */
} DMA_State_TypeDef;
...
typedef enum {
    DMA_FLAG_GIF =
        ((uint8_t)DMA_STS_GIF), /*!< DMA FLAG: Global interrupt flag */
    DMA_FLAG_TCIF = ((uint8_t)DMA_STS_TCIF), /*!< DMA FLAG: Transmission
                                                completion interrupt flag bit */
    DMA_FLAG_HTIF =
        ((uint8_t)DMA_STS_HTIF), /*!< DMA FLAG: Transmit half interrupt flag */
    DMA_FLAG_TEIF =
        ((uint8_t)
             DMA_STS_TEIF), /*!< DMA FLAG: Transmission error interrupt flag */
} DMA_Flag_TypeDef;
...
typedef struct
{
    ...
    uint16_t
        DMA_CircularMode; /*!< Specifies the DMA mode.
                                                               This parameter
                             can be a value of @ref DMA_CircularMode_TypeDef */
    ...
    uint32_t
        DMA_Request; /*!< DMA request source.
                                                                This parameter
                        can be a value of @ref DMA_Request_TypeDef */
