...
typedef enum {
    LEDPWM_PRESCALER_DIV1 =
        (uint16_t)(0x00U
                   << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/1 */
    LEDPWM_PRESCALER_DIV2 =
        (uint16_t)(0x01U
                   << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/2 */
    LEDPWM_PRESCALER_DIV4 =
        (uint16_t)(0x02U
                   << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/4 */
    LEDPWM_PRESCALER_DIV8 =
        (uint16_t)(0x03U
                   << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/8 */
    LEDPWM_PRESCALER_DIV16 =
        (uint16_t)(0x04U
                   << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/16 */
    LEDPWM_PRESCALER_DIV32 =
        (uint16_t)(0x05U
                   << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/32 */
    LEDPWM_PRESCALER_DIV64 =
        (uint16_t)(0x06U
                   << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/64 */
    LEDPWM_PRESCALER_DIV128 =
        (uint16_t)(0x07U << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division:
                                                       Fsource/128    */
    LEDPWM_PRESCALER_DIV256 =
        (uint16_t)(0x08U << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division:
                                                       Fsource/256    */
} LEDPWM_Prescaler_TypeDef;

#define IS_LEDPWM_PRESCALER(PRESCALER)                                         \
    (((PRESCALER) == LEDPWM_PRESCALER_DIV1) ||                                 \
...
typedef enum {
    ...
    LEDPWM_AlignmentMode_Center =
        (uint16_t)(0x01U
                   << LEDPWM_CON_PWMMD0_Pos), /*!< Center Alignment mode */
} LEDPWM_AlignedMode_TypeDef;

#define IS_LEDPWM_AlignedMode(MODE)                                            \
    (((MODE) == LEDPWM_AlignmentMode_Edge) ||                                  \
...
#    define IS_LEDPWM_CHANNEL(CHANNEL)                                         \
        (((CHANNEL) & (uint32_t)0xFFFFFF00) == 0x00)
...
typedef enum {
    ...
    LEDPWM_Channel_32_38 =
        (int32_t)0x8000007UL, /*!< PMW output channel 32_38 */
} LEDPWM_Channel_Typedef;
