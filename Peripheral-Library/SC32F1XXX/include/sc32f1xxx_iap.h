...
#    if defined(SC32f10xx) || defined(SC32f11xx)
uint8_t IAP_ProgramHalfWordArray(uint32_t  Address,
                                 uint16_t* ByteArray,
                                 uint16_t  ArraySize);
uint8_t
IAP_ProgramByteArray(uint32_t Address, uint8_t* ByteArray, uint16_t ArraySize);
#    endif
uint8_t
IAP_ReadWordArray(uint32_t Address, uint32_t* ByteArray, uint16_t ArraySize);
uint8_t IAP_ReadHalfWordArray(uint32_t  Address,
                              uint16_t* ByteArray,
                              uint16_t  ArraySize);
uint8_t
IAP_ReadByteArray(uint32_t Address, uint8_t* ByteArray, uint16_t ArraySize);
