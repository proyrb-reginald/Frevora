...
typedef enum {
    TWI_Ack_Disable =
        (uint16_t)(0X00U << TWI_CON_AA_Pos), /*!< TWI Ack:Disable    */
...
typedef enum {
    TWI_PRESCALER_4096 =
        (uint16_t)(0x00U
                   << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/4096    */
    TWI_PRESCALER_2048 =
        (uint16_t)(0x01U
                   << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/2048    */
    TWI_PRESCALER_1024 =
        (uint16_t)(0x02U
                   << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/1024    */
    TWI_PRESCALER_512 =
        (uint16_t)(0x03U
                   << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/512    */
    TWI_PRESCALER_256 =
        (uint16_t)(0x04U
                   << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/256    */
    TWI_PRESCALER_128 =
        (uint16_t)(0x05U
                   << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/128    */
    TWI_PRESCALER_64 =
        (uint16_t)(0x06U
                   << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/64    */
    TWI_PRESCALER_32 =
        (uint16_t)(0x07U
                   << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/32    */
    TWI_PRESCALER_16 =
        (uint16_t)(0x08U
                   << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/16    */
    TWI_PRESCALER_8 =
...
typedef enum {
    TWI_Stretch_Disable =
        0X00U << TWI_CON_STRETCH_Pos, /*!< TWI Slave Clock Stretch:Disable    */
    TWI_Stretch_Enable =
...
typedef enum {
    TWI_GeneralCall_Disable =
        0X00U << TWI_ADD_GC_Pos, /*!< TWI General Call State:Disable    */
    TWI_GeneralCall_Enable =
        0X01U << TWI_ADD_GC_Pos, /*!< TWI General Call State:Enable    */
...
typedef enum {
    ...
    TWI_PinRemap_A =
        (uint32_t)(0x01
                   << TWI_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode A */
    TWI_PinRemap_B =
        (uint32_t)(0x02
                   << TWI_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode B */
    TWI_PinRemap_C =
        (uint32_t)(0x03
                   << TWI_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode C */
...
typedef enum {
    ...
    TWI_PinRemap_D =
        (uint32_t)(0x04
                   << TWI_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode D */
    TWI_PinRemap_E =
        (uint32_t)(0x05
                   << TWI_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode E */
    TWI_PinRemap_F =
        (uint32_t)(0x06
                   << TWI_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode F */
    TWI_PinRemap_G =
        (uint32_t)(0x07
                   << TWI_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode G */
} TWI_PinRemap_TypeDef;
...
#    define IS_TWI_LIST1_PINREMAP(REMAP)                                       \
        (((REMAP) == TWI_PinRemap_Default) || ((REMAP) == TWI_PinRemap_A) ||   \
         ...
         ((REMAP) == TWI_PinRemap_F) || ((REMAP) == TWI_PinRemap_G))
...
typedef enum {
    ...
    TWI_FLAG_TXRXnE = (uint32_t)
        TWI_STS_TXERXE, /*!< TWI Flag: Transmit/receive completion flag */
    TWI_FLAG_GCA  = (uint32_t)TWI_STS_GCA, /*!< TWI Flag: Generic Call flags */
    TWI_FLAG_MSTR = (uint32_t)
        TWI_STS_MSTR, /*!< TWI Flag: Flag to identify master or slave */
} TWI_FLAG_TypeDef;
