...
typedef enum {
    PWM_PRESCALER_DIV1 =
        (uint16_t)(0x00U
                   << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/1    */
    PWM_PRESCALER_DIV2 =
        (uint16_t)(0x01U
                   << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/2    */
    PWM_PRESCALER_DIV4 =
        (uint16_t)(0x02U
                   << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/4    */
    PWM_PRESCALER_DIV8 =
        (uint16_t)(0x03U
                   << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/8    */
    PWM_PRESCALER_DIV16 =
        (uint16_t)(0x04U
                   << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/16    */
    PWM_PRESCALER_DIV32 =
        (uint16_t)(0x05U
                   << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/32    */
    PWM_PRESCALER_DIV64 =
        (uint16_t)(0x06U
                   << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/64    */
    PWM_PRESCALER_DIV128 =
        (uint16_t)(0x07U
                   << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/128 */
    PWM_PRESCALER_DIV256 =
        (uint16_t)(0x08U
                   << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/256 */
} PWM_Prescaler_TypeDef;

#define IS_PWM_PRESCALER(PRESCALER)                                            \
    (((PRESCALER) == PWM_PRESCALER_DIV1) ||                                    \
...
typedef enum {
    PWM_WorkMode_Independent =
        (uint16_t)(0x00U
                   << PWM_CON_PWMMD1_Pos), /*!< Independent working mode */
    PWM_WorkMode_Complementary =
        (uint16_t)(0x01U
                   << PWM_CON_PWMMD1_Pos), /*!< Complementary working mode*/
...
typedef enum {
    PWM_FDMode_Latch =
        (uint16_t)(0x00U << PWM_FLT_FLTMD_Pos), /*!< PWM fault detection mode:
                                                   Latch mode */
    PWM_FDMode_Immediate =
        (uint16_t)(0x01U << PWM_FLT_FLTMD_Pos), /*!< PWM fault detection mode:
                                                   Immediate mode */
} PWM_FDMode_TypeDef;
...
typedef enum {
    PWM_FDVoltage_Low =
        (uint16_t)(0x00U << PWM_FLT_FLTTV_Pos), /*!< PWM fault detection
                                                   Voltage:Low level */
    PWM_FDVoltage_High =
        (uint16_t)(0x01U << PWM_FLT_FLTTV_Pos), /*!< PWM fault detection
                                                   Voltage:High level */
...
typedef enum {
    PWM_FilteringTime_0us =
        (uint16_t)(0x00U
                   << PWM_FLT_FLTDT_Pos), /*!< PWM fault detection input signal
...
#define IS_PWM_FDFILTERINGTIME(TIME)                                           \
    (((TIME) == PWM_WaveFilteringTime_0us) ||                                  \
...
typedef enum {
    PWM_Flag_PWMIF =
        (uint8_t)PWM_STS_PWMIF, /*!< PWM Interrupt: PWM Interrupt */
    PWM_Flag_FLTSTA =
        (uint8_t)PWM_STS_FLTSTA, /*!< PWM Interrupt: Flult Interrupt */
} PWM_Flag_TypeDef;

#define IS_PWM_FLAG(FLAG)                                                      \
    ((((FLAG) & (uint8_t)0xFC) == 0x00) && ((FLAG) != (uint8_t)0x00))

#define IS_GET_PWM_FLAG(FLAG)                                                  \
    (((FLAG) == PWM_Flag_PWMIF) || ((FLAG) == PWM_Flag_FLTSTA))
/**
 * @}
 */
...
typedef struct
{
    ...
    uint16_t
        PWM_WorkMode; /*!< Specifies the work mode.
...
{
    uint16_t
        PWM_FDMode;         /*!<  Specifies the PWM fault detection mode.
                                                                                This
                               parameter can be a value of @ref PWM_FDMode_TypeDef */
    uint16_t PWM_FDVoltage; /*!<  Specifies the PWM fault detection active
                               level. This parameter can be a value of @ref
                               PWM_FDVoltage_TypeDef */
    uint16_t
        PWM_FDFilteringTime; /*!<  Specifies the PWM fault detection filtering
