...
typedef enum {
    RCC_SYSCLKSource_HIRC =
        (uint16_t)(~RCC_CFG0_SYSCLKSW), /*!< SYSCLK Source �� HIRC */
    RCC_SYSCLKSource_LIRC    = (uint16_t)((
        0x00 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source �� LIRC */
    RCC_SYSCLKSource_HXT     = (uint16_t)((
        0x01 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source �� HXT */
    RCC_SYSCLKSource_PLLRCLK = (uint16_t)((
        0x02 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source �� PLLCK */
    RCC_SYSCLKSource_LXT     = (uint16_t)((
        0x03 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source �� LXT */
...
typedef enum {
    ...
    RCC_SYSCLKSource_HXT  = (uint16_t)((
        0x01 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source �� HXT */
    RCC_SYSCLKSource_HIRC = (uint16_t)((
        0x02 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source �� HIRC */
    RCC_SYSCLKSource_LXT  = (uint16_t)((
        0x03 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source �� LXT */
} RCC_SYSCLKSource_TypeDef;
...
typedef enum {
    RCC_SysTickSource_HCLK_DIV8 =
        (uint8_t)(0X00
                  << RCC_CFG1_STCLKSEL_Pos), /*!< SysTickCLK clock = HCLK/8 */
    RCC_SysTickSource_HIRC_DIV2 =
        (uint8_t)(0X01
                  << RCC_CFG1_STCLKSEL_Pos), /*!< SysTickCLK clock = HIRC/2 */
    RCC_SysTickSource_HXT_DIV2 =
        (uint8_t)(0X02
                  << RCC_CFG1_STCLKSEL_Pos), /*!< SysTickCLK clock = HXT/2 */
    RCC_SysTickSource_LIRC =
        (uint8_t)(0X03
                  << RCC_CFG1_STCLKSEL_Pos), /*!< SysTickCLK clock = LIRC */
...
typedef enum {
    RCC_SYSCLK_Div1 =
        (uint32_t)(0x00 << AHB_CFG_CLKDIV_Pos), /*!< AHB clock = SYSCLK */
    RCC_SYSCLK_Div2 =
        (uint32_t)(0x01 << AHB_CFG_CLKDIV_Pos), /*!< AHB clock = SYSCLK/2 */
    RCC_SYSCLK_Div4 =
        (uint32_t)(0x02 << AHB_CFG_CLKDIV_Pos), /*!< AHB clock = SYSCLK/4 */
    RCC_SYSCLK_Div8 =
        (uint32_t)(0x03 << AHB_CFG_CLKDIV_Pos), /*!< AHB clock = SYSCLK/8 */
    RCC_SYSCLK_Div16 =
...
typedef enum {
    RCC_HCLK_Div1 =
        (uint32_t)(0x00 << AHB_CFG_CLKDIV_Pos), /*!< APB clock = AHB */
    RCC_HCLK_Div2 =
        (uint32_t)(0x01 << AHB_CFG_CLKDIV_Pos), /*!< APB clock = AHB/2 */
    RCC_HCLK_Div4 =
        (uint32_t)(0x02 << AHB_CFG_CLKDIV_Pos), /*!< APB clock = AHB/4 */
    RCC_HCLK_Div8 =
        (uint32_t)(0x03 << AHB_CFG_CLKDIV_Pos), /*!< APB clock = AHB/8 */
    RCC_HCLK_Div16 =
        (uint32_t)(0x04 << AHB_CFG_CLKDIV_Pos), /*!< APB clock = AHB/16 */
    RCC_HCLK_Div32 =
        (uint32_t)(0x05 << AHB_CFG_CLKDIV_Pos), /*!< APB clock = AHB/32 */
    RCC_HCLK_Div64 =
        (uint32_t)(0x06 << AHB_CFG_CLKDIV_Pos), /*!< APB clock = AHB/64 */
    RCC_HCLK_Div128 =
        (uint32_t)(0x07 << AHB_CFG_CLKDIV_Pos), /*!< APB clock = AHB/128 */
} RCC_PCLK_TypeDef;
...
#        define IS_RCC_APB0PERIPH(PERIPH)                                      \
            ((((PERIPH) & (uint8_t)0xFE00) == 0x00) &&                         \
             ((PERIPH) != (uint16_t)0x00))
...
#        define IS_RCC_NMIPeriph(NMIPeriph)                                    \
            ((((NMIPeriph) & (uint8_t)0xFF00) == 0x00) &&                      \
             ((NMIPeriph) != (uint16_t)0x00))
#    elif defined(SC32f15xx)
typedef enum {
    RCC_NMIPeriph_INT0   = (uint16_t)NMI_CFG_INT0EN,
    RCC_NMIPeriph_SRAMPE = (uint16_t)NMI_CFG_SRAMPEEN,
...
typedef enum {
    RCC_WAIT_0 = (uint16_t)0x00
                 << RCC_CFG0_WAIT_Pos, /*!< Wait number selection 0 */
    RCC_WAIT_1 = (uint16_t)0x01
                 << RCC_CFG0_WAIT_Pos, /*!< Wait number selection 1 */
    RCC_WAIT_2 = (uint16_t)0x02
                 << RCC_CFG0_WAIT_Pos, /*!< Wait number selection 2 */
    RCC_WAIT_3 = (uint16_t)0x03
                 << RCC_CFG0_WAIT_Pos, /*!< Wait number selection 3 */
} RCC_Wait_TypeDef;
#    define IS_RCC_Wait(Wait)                                                  \
        (((Wait) == RCC_WAIT_0) || ((Wait) == RCC_WAIT_1) ||                   \
         ((Wait) == RCC_WAIT_2) || ((Wait) == RCC_WAIT_3))
...
typedef enum {
    ...
    RCC_FLAG_PLLRDY =
        (uint8_t)RCC_STS_PLLRDY, /*!< RCC FLAG: PLL Clock Ready Flag */
} RCC_FLAG_TypeDef;
