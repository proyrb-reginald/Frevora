...
typedef enum {
    CAN_Standard_format =
        (uint8_t)(0x00 << CAN_TX_CTRL_IDE_Pos), /*!<Packets are sent in standard
                                                   mode*/
    CAN_Extended_format =
        (uint8_t)(0x01
                  << CAN_TX_CTRL_IDE_Pos), /*!<Packets are in extended mode*/
} CAN_IDEMODE_Typedef;

#    define IS_CAN_IDEMODE(IDEMODE)                                            \
        (((IDEMODE) == CAN_Standard_format) ||                                 \
         ((IDEMODE) == CAN_Extended_format))
...
typedef enum {
    CAN_Data_frame =
        (uint8_t)(0x0L
                  << CAN_TX_CTRL_RTR_Pos), /*!<The message uses a data frame*/
    CAN_Remote_frame =
        (uint8_t)(0x1L
                  << CAN_TX_CTRL_RTR_Pos), /*!<The packet uses a remote frame*/
} CAN_RTRMODE_Typedef;
...
typedef enum {
    ...
    CAN_Standard_frame =
        (uint8_t)(0x00 << CAN_TX_CTRL_FDF_Pos), /*!<The packet uses 2.0 frames*/
    CAN_FD_frame =
        (uint8_t)(0x01
                  << CAN_TX_CTRL_FDF_Pos), /*!<The message uses an FD frame*/
...
typedef enum {
    CAN_Disable_BRS =
        (uint8_t)(0x00 << CAN_TX_CTRL_BRS_Pos), /*!<Packet bit rate switching is
                                                   disabled. Procedure*/
    CAN_Enable_BRS =
        (uint8_t)(0x01 << CAN_TX_CTRL_BRS_Pos), /*!<The packet allows switching
                                                   of the bit rate*/
...
typedef enum {
    ...
    CAN_TPSS_Enable =
        (uint32_t)(0x00 << CAN_CFG_STAT_TPSS_Pos), /*!<Enable automatic PTB
                                                      retransmission*/
    CAN_TPSS_Disable =
        (uint32_t)(0x01 << CAN_CFG_STAT_TPSS_Pos), /*!<Disable automatic PTB
                                                      retransmission*/
...
typedef enum {
    ...
    CAN_TSSS_Enable =
        (uint32_t)(0x00 << CAN_CFG_STAT_TSSS_Pos), /*!<Enable automatic STB
                                                      retransmission*/
    CAN_TSSS_Disable =
        (uint32_t)(0x01 << CAN_CFG_STAT_TSSS_Pos), /*!<Disable STB automatic
                                                      retransmission*/
...
typedef enum {
    ...
    CAN_TxDisable =
        (uint16_t)(0x00 << CAN_IDE_TXEN_Pos), /*!<The CAN sending function is
                                                 disabled*/
    CAN_TxEnable =
        (uint16_t)(0x01 << CAN_IDE_TXEN_Pos), /*!<The CAN sending function was
                                                 enabled*/
} CANTXEN_TypeDef;
...
typedef enum {
    CAN_RxDisable =
        (uint16_t)(0x00 << CAN_IDE_RXEN_Pos), /*!<The CAN receiving function is
                                                 disabled*/
    CAN_RxEnable =
        (uint16_t)(0x01 << CAN_IDE_RXEN_Pos), /*!<The CAN receiving function was
                                                 enabled*/
} CANRXEN_TypeDef;
...
typedef enum {
    CAN_ROM_Old =
        (uint32_t)(0x00 << CAN_CFG_STAT_ROM_Pos), /*!<The oldest packet was
                                                     discarded. Procedure*/
    CAN_ROM_New =
        (uint32_t)(0x01
                   << CAN_CFG_STAT_ROM_Pos), /*!<Discard the latest packet*/
} CANROM_TypeDef;
#    define IS_CANROM(CANROM)                                                  \
        (((CANROM) == CAN_ROM_Old) || ((CANROM) == CAN_ROM_New))
...
#    define IS_FliterNumber(FliterNumber)                                      \
        (((FliterNumber) == CAN_Fliter0) || ((FliterNumber) == CAN_Fliter1) || \
         ((FliterNumber) == CAN_Fliter2) || ((FliterNumber) == CAN_Fliter3) || \
         ((FliterNumber) == CAN_Fliter4) || ((FliterNumber) == CAN_Fliter5) || \
         ((FliterNumber) == CAN_Fliter6) || ((FliterNumber) == CAN_Fliter7))
/** @brief The CAN filter selects standard frames from extended frames
 * @{
 */
typedef enum {
    CAN_Fliter_Standard =
        (uint8_t)(0x00 << CAN_ACFCTRL_ACFADR_Pos), /*!<Only standard frames pass
                                                      through the filter*/
    CAN_Fliter_Extension =
        (uint8_t)(0x01
                  << CAN_ACFCTRL_ACFADR_Pos), /*!<Let only the extension frames
                                                 pass through the filter*/
    CAN_Fliter_Default = (uint8_t)(0x02 << CAN_ACFCTRL_ACFADR_Pos), /*No limit*/
} FliterFrame_TypeDef;
...
typedef enum {
    ...
    CAN_INToff = (uint8_t)(0x00 << CAN_IDE_INTEN_Pos), /*!<Interrupt mask*/
    CAN_INTon  = (uint8_t)(0x01 << CAN_IDE_INTEN_Pos), /*!<Interrupt on*/
} CANInt_TypeDef;
#    define IS_CANInt(CANInt)                                                  \
        (((CANInt) == CAN_INToff) || ((CANInt) == CAN_INTon))
/** @brief CAN send packet mode Select
 * @{
 */
typedef enum {

    CAN_TxFIFO = (uint8_t)(0x00 << CAN_CFG_STAT_TSMODE_Pos), /*!<FIFO mode*/
    CAN_IDPriority =
        (uint8_t)(0x01 << CAN_CFG_STAT_TSMODE_Pos), /*!<ID priority mode*/
} CANTSMODE_TypeDef;
...
/*CAN�ж�ö��*/
typedef enum {
    CAN_INTEN = (uint8_t)(0x01 << CAN_IDE_INTEN_Pos), /*!<The  interrupt
                                                         function was enabled*/
    CAN_RIEEN =
        (uint16_t)(0x01 << CAN_RTIE_RIE_Pos), /*!<The receiving interrupt
                                                 function was enabled*/
    CAN_ROIEEN =
        (uint16_t)(0x01 << CAN_RTIE_ROIE_Pos), /*!<Overflow interrupt was
                                                  enabled. Procedure*/
    CAN_RFIEEN =
        (uint16_t)(0x01 << CAN_RTIE_RFIE_Pos), /*!<RB full interrupt was
                                                  enabled. Procedure*/
    CAN_RAFIEEN =
        (uint16_t)(0x01
                   << CAN_RTIE_RAFIE_Pos), /*!<RB slots Threshold warning
                                              Indicates the interrupt function*/
    CAN_TPIEEN =
        (uint16_t)(0x01 << CAN_RTIE_TPIE_Pos), /*!<The interruption of PTB
                                                  transmission completion was
                                                  enabled*/
    CAN_TSIEEN =
        (uint16_t)(0x01
                   << CAN_RTIE_TSIE_Pos), /*!<The STB transmission completion
                                             interrupt was enabled*/
    CAN_EIEEN = (uint16_t)(0x01 << CAN_RTIE_EIE_Pos), /*!<The error interrupt
                                                         function was enabled*/
    CAN_ALIEEN =
        (uint16_t)(0x01
                   << CAN_RTIE_ALIE_Pos), /*!<The arbitration loss interruption
                                             function was enabled*/
    CAN_BEIEEN =
        (uint32_t)(0x01 << CAN_RTIE_BEIE_Pos), /*!<Bus error interrupt enabled*/
    CAN_EPIEEN =
        (uint32_t)(0x01 << CAN_RTIE_EPIE_Pos), /*!<Error passive interrupt
                                                  enable bit*/
} CAN_INT_TypeDef;
#    define IS_CAN_INT(CAN_INT)                                                \
        (((CAN_INT) == CAN_RIEEN) || ((CAN_INT) == CAN_ROIEEN) ||              \
         ...
         ((CAN_INT) == CAN_BEIEEN) || ((CAN_INT) == CAN_EPIEEN))
/** @brief CAN disables the mask switch
 * @{
 */
...
typedef enum {
    CAN_FlAG_RIF =
        (uint32_t)(0x01 << CAN_RTIE_RIF_Pos), /*!<Select the RIF FLAG*/
    CAN_FlAG_TSFF =
        (uint16_t)(0x01 << CAN_RTIE_TSFF_Pos), /*!<Select the TSFF FLAG*/
    CAN_FlAG_AIF =
        (uint16_t)(0x01 << CAN_RTIE_AIF_Pos), /*!<Select the AIF FLAG*/
    CAN_FlAG_EIF =
        (uint16_t)(0x01 << CAN_RTIE_EIF_Pos), /*!<Select the EIF FLAG*/
    CAN_FlAG_TSIF =
        (uint16_t)(0x01 << CAN_RTIE_TSIF_Pos), /*!<Select the TSIF FLAG*/
    CAN_FlAG_TPIF =
        (uint16_t)(0x01 << CAN_RTIE_TPIF_Pos), /*!<Select the TPIF FLAG*/
    CAN_FlAG_RAFIF =
        (uint16_t)(0x01 << CAN_RTIE_RAFIF_Pos), /*!<Select the RAFIF FLAG*/
    CAN_FlAG_RFIF =
        (uint16_t)(0x01 << CAN_RTIE_RFIF_Pos), /*!<Select the RFIF FLAG*/
    CAN_FlAG_ROIF =
        (uint16_t)(0x01 << CAN_RTIE_ROIF_Pos), /*!<Select the ROIF FLAG*/
    CAN_FlAG_ALIF =
        (uint16_t)(0x01 << CAN_RTIE_ALIF_Pos), /*!<Select the ALIF FLAG*/
    CAN_FlAG_BEIF =
        (uint32_t)(0x01 << CAN_RTIE_BEIF_Pos), /*!<Select the BEIF FLAG*/
    CAN_FlAG_EPIF =
        (uint32_t)(0x01 << CAN_RTIE_EPIF_Pos), /*!<Select the EPIF FLAG*/
} CAN_FLAG_TypeDef;
...
typedef enum {
    ...
    CAN_TimeStampDisable =
        (uint8_t)(0x00
                  << CAN_ACFCTRL_TIMEEN_Pos), /*!<The timestamp is disabled*/
    CAN_TimeStampEnable =
        (uint8_t)(0x01
                  << CAN_ACFCTRL_TIMEEN_Pos), /*!<The timestamp was enabled*/
...
typedef enum {
    ...
    CAN_TimeStampCntDisable =
        (uint16_t)(0x00 << CAN_IDE_TIMEN_Pos), /*!<Disable the timestamp
                                                  counting function*/
    CAN_TimeStampCntEnable =
        (uint16_t)(0x00 << CAN_IDE_TIMEN_Pos), /*!<Enable the timestamp counting
                                                  function*/
...
typedef enum {
    ...
    CAN_TimeStampPosition_SOF =
        (uint16_t)(0x00
                   << CAN_ACFCTRL_TIMEPOS_Pos), /*!<Select the frame start as
                                                   the timestamp location*/
    CAN_TimeStampPosition_EOF =
        (uint16_t)(0x01
                   << CAN_ACFCTRL_TIMEPOS_Pos), /*!<Select the end of frame as
                                                   the timestamp location*/
...
typedef enum {
    CAN_TransMod_TPE =
        (uint16_t)(0x01
                   << CAN_CFG_STAT_TPE_Pos), /*!<PTB Send a single message*/
    CAN_TransMod_TSONE =
        (uint16_t)(0x01 << CAN_CFG_STAT_TSONE_Pos), /*!<STB single send*/
    CAN_TransMod_TSALL =
...
{
    uint32_t
        CAN_TXID; /*!< This member configures the ID of the CAN sent data */
    uint32_t Tx_msg[8]; /*!< This member configures the sending data of CAN*/
    uint16_t Data_len;  /*!< This member configures the length of the sent data
                           of CAN*/
    uint8_t CAN_RTR; /*!< This member configures whether the sent data of CAN is
                        a remote frame*/
    uint8_t CAN_FDF; /*!< This member configures whether the sent data of CAN is
                        FD*/
    uint8_t CAN_BRS; /*!<This member configures whether CAN sends data at a
                        variable baud rate*/
    uint8_t CAN_IDE; /*!< This member configures whether the sent data of CAN is
                        an extended frame*/
    uint8_t Tx_msg_len; /*!< This member configures the number of data sent by
                           CAN */
} CanTxMsg;
...
typedef struct
{
    ...
    uint8_t
        CAN_IDE; /*!< This member is The frame format of the received data */
    uint16_t
        Data_len;    /*!< This member is the length of the receive data of CAN*/
    uint8_t CAN_RTR; /*!< This member is The frame format of the received data*/
    uint8_t CAN_FDF; /*!< This member configures whether the received data of
                        CAN is FD*/
    uint8_t CAN_BRS; /*!<This member Gets whether the baud rate of the received
                        data is variable */
} CanRxMsg;
...
typedef struct
{
    ...
    uint32_t CAN_MOD;      /*!< This member configures CAN  mode.
                                                   This parameter can be a value of
                              @ref ModSelect_TypeDef */

    uint32_t CANTSMODESelect; /*!< This member configures CAN TSMODESelect.
                                                This parameter can be a value of
                                 @ref CANTSMODE_TypeDef */

    uint32_t CANFDISOSelect; /*!< This member configures CAN FDISO Select.
                                              This parameter can be a value of
                                @ref CANFD_ISO_MODE_TypeDef */

    uint16_t CANTimeStampPositon; /*!< This member configures CAN TimeStamp
                                     Positon. This parameter can be a value of
                                     @ref CANTimeStampPosition_TypeDef */
    ...
    FunctionalState CANTimeStamp; /*!< This member configures CAN TimeStamp
                                     mode. This parameter can be a value of @ref
                                     FunctionalState */

    FunctionalState CANTimeStampCnt; /*!< This member configures CAN
                                        TimeStampCnt mode. This parameter can be
                                        a value of @ref FunctionalState */

    FunctionalState
        CAN_PTB_AutoRetrans; /*!< This member configures CAN PTB AutoRetrans
                                enable. This parameter can be a value of @ref
                                FunctionalState */

    FunctionalState
        CAN_STB_AutoRetrans; /*!< This member configures CAN STB AutoRetrans
                                enable. This parameter can be a value of @ref
                                FunctionalState */
...
void CAN_FBaudRate_Select(unsigned int CAN_Clk,
                          unsigned int CAN_FPrescaler,
                          uint32_t     BaudRate);
void CAN_SBaudRate_Select(unsigned int CAN_Clk,
                          unsigned int CAN_FPrescaler,
                          uint32_t     BaudRate);
...
void CAN_TDCompensateCmd(CAN_TypeDef* CANx, FunctionalState NewState);
