...
/** @defgroup ADC_Exported_Functions_Group1 Configuration of the ADC computation
unit functions
 ...
 *                         SC32f10xx Selection range(ADC_Channel_0 -
 * ADC_Channel_16����ADC_Channel_VDD_D4) SC32f11xx Selection range(ADC_Channel_0
 * - ADC_Channel_17����ADC_Channel_VDD_D4��ADC_Channel_PGA) SC32f12xx Selection
 * range(ADC_Channel_0 - ADC_Channel_15����ADC_Channel_VDD_D4��ADC_Channel_OP)
 *                         SC32f15xx Selection range(ADC_Channel_0 -
 * ADC_Channel_15����ADC_Channel_VDD_D4��ADC_Channel_TEMP)
...
/**
 * @brief  Enables or disables the software conversion enable function of the
 * specified ADC.
 * @param  ADCx[out]: select the ADCx peripheral.
 *                  - ADC: Only ADC can be select the ADCx peripheral.
 * @retval None
 ...
 * @param  ADCx[out]: select the ADCx peripheral.
 *                  - ADC: Only ADC can be select the ADCx peripheral.
 * @param  ADC_IT[in]: specifies the ADC interrupts sources to be enabled or
 * disabled. SC32f10xx Selection range(ADC_IT_ADCIF) SC32f11xx Selection
 * range(ADC_IT_ADCIF) SC32f12xx Selection range(ADC_IT_ADCIF) SC32f15xx
 * Selection range(ADC_IT_INTEN - ADC_IT_LOWTHIE)
 *                  - ADC_IT_ADCIF:ADC Interrupt: ADC  Interrupt
 *                  - ADC_IT_INTEN:ADC Interrupt: ADC  Interrupt
 *                  - ADC_IT_EOCIE:ADC sequence 0 sampling + conversion complete
 * interrupt Flag
 *                  - ADC_IT_EOSIE0:ADC sequence 0 sampling + conversion
 ...
 *                  - ADC_Flag_EOSIF0:ADC sequence 0 sampling + conversion
 * complete interrupt Flag
