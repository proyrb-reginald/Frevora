...
/** @defgroup QEP_Exported_Functions_Group1 Configuration of the QEP computation
unit functions
 ...
 *               - QEPQ0: select the PCAP peripheral
 *               - QEP1: select the PCAP peripheral
 *         QEP_InitStruct[out]: Pointer to structure QEP_InitTypeDef, to be
 * initialized.
 * @retval None
 */
void QEP_Init(QEP_TypeDef* QEPx, QEP_InitTypeDef* QEP_InitStruct)
{
    ...
    tmpreg = QEPx->QEP_CON;
    tmpreg &=
        ~(QEP_CON_QSRC | QEP_CON_RPCEN | QEP_CON_FPCEN | QEP_CON_QIP |
          QEP_CON_QAGATE | QEP_CON_QBGATE | QEP_CON_IGATE | QEP_CON_QFDIV |
          QEP_CON_QAP | QEP_CON_QBP | QEP_CON_PCRM | QEP_CON_SWAP);

    tmpreg |= (QEP_InitStruct->QEP_Mode | QEP_InitStruct->QEP_CEN |
               QEP_InitStruct->QEP_GATE | QEP_InitStruct->QEP_QFDIV |
               QEP_InitStruct->QEP_IndexMode | QEP_InitStruct->QEP_QEPnI |
 ...
 * @param  QEP_InitStruct[out]: pointer to a QEP_InitTypeDef structure which
 * will be initialized.
 * @retval None
 */
 ...
 *               - QEP_Mode_Orthogonal:Location count source selection
 * Orthogonal
 ...
 *               - QEPQ0: select the PCAP peripheral
 *               - QEP1: select the PCAP peripheral
 * @param  QEP_IT[in]: specifies the QEP interrupts sources to be enabled or
 * disabled.
