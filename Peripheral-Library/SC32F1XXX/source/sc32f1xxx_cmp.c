...
/**
 * @brief  DeInitialize the CMPx peripheral registers to their default reset
 * values.
 * @param  CMPx[out]:
...
/**
 * @brief  Initializes the peripheral CMP register according to the parameters
 * specified in CMP_InitStruct
 * @param  CMPx[out]:
 *                SC32f10xx Selection range(CMP)
 *                SC32f11xx Selection range(CMP)
 *                SC32f12xx Selection range(CMP)
 ...
 *               - CMP_2: select the CMP2 peripheral
 *               - CMP3: select the CMP3 peripheral
 * @param  CMP_InitStruct[out]:pointer to a CMP_InitTypeDef structure which will
 * be initialized.
 * @retval None
 */
void CMP_Init(CMP_TypeDef* CMPx, CMP_InitTypeDef* CMP_InitStruct)
{
    ...
    if (CMPx == CMP_0 || CMPx == CMP_1 || CMPx == CMP_2) {
        ...
        CMP3->CMP_CON |=
            (uint32_t)(CMP_InitStruct->CMP_VREF | CMP_InitStruct->CMP_HYS);

        /*---------------------------- CMPx CMP_CFG Configuration
         * ------------------------*/
        tmpreg = CMP3->CMP_CFG;

        tmpreg &= (uint16_t)~(CMP_CFG_CMPIM | CMP_CFG_CMPNS | CMP_CFG_CMPPS |
                              CMP_CFG_CMPRF);
 ...
 *                  - CMPx_Negative_1D16VDD:The comparison voltage of CMP is
 * 1/16VDD
 *                  - CMPx_Negative_2D16VDD:The comparison voltage of CMP is
 * 2/16VDD
 *                  - CMPx_Negative_3D16VDD:The comparison voltage of CMP is
 * 3/16VDD
 *                  - CMPx_Negative_4D16VDD:The comparison voltage of CMP is
 * 4/16VDD
 *                  - CMPx_Negative_5D16VDD:The comparison voltage of CMP is
 * 5/16VDD
 *                  - CMPx_Negative_6D16VDD:The comparison voltage of CMP is
 * 6/16VDD
 *                  - CMPx_Negative_7D16VDD:The comparison voltage of CMP is
 * 7/16VDD
 *                  - CMPx_Negative_8D16VDD:The comparison voltage of CMP is
 * 8/16VDD
 *                  - CMPx_Negative_9D16VDD: The comparison voltage of CMP is
 * 9/16VDD
 *                  - CMPx_Negative_10D16VDD:The comparison voltage of CMP is
 * 10/16VDD
 *                  - CMPx_Negative_11D16VDD:The comparison voltage of CMP is
 * 11/16VDD
 *                  - CMPx_Negative_12D16VDD:The comparison voltage of CMP is
 * 12/16VDD
 *                  - CMPx_Negative_13D16VDD:The comparison voltage of CMP is
 * 13/16VDD
 *                  - CMPx_Negative_14D16VDD:The comparison voltage of CMP is
 * 14/16VDD
 *                  - CMPx_Negative_15D16VDD:The comparison voltage of CMP is
 * 15/16VDD
 * @retval None
 */
 ...
 *                  SC32f10xx Selection
 * range(CMP_Positive_CMP0-CMP_Positive_CMP3,CMP_Positive_1_5V) SC32f11xx
 * Selection
 * range(CMP_Positive_CMP0-CMP_Positive_CMP1,CMP_Positive_1_5V,CMP_Positive_PGA)
 *                  SC32f12xx Selection
 * range(CMP_Positive_CMP0-CMP_Positive_CMP3,CMP_Positive_1_5V,CMP_Positive_OP)
 *                  SC32f15xx Selection
 * range(CMP0_Positive_CMP0P-CMP3_Positive_OP2O)
 ...
 *                  - CMP_Positive_1_5V:Select CMPP as the CMP input port,CMPP
 ...
 *                  - CMP0_Positive_CMP0P:CMP0 Select CMP0P as the CMP0 Positive
 * port
 *                  - CMP0_Positive_OP1O:CMP0 Select OP1O as the CMP Positive
 * port
 *                  - CMP0_Positive_OP2O:CMP0 Select OP2O as the CMP Positive
 * port
...
CMP_Positive_TypeDef CMP_GetPositiveChannel(CMP_TypeDef* CMPx)
{
    ...
    return (CMP_Positive_TypeDef)(CMPx->CMP_CFG &
                                  (CMP_CFG_CMPIS | CMP_CFG_CMPP));
#elif defined(SC32f15xx)
    ...
    if (CMPx == CMP_0) {
        ReadCMPPositive =
            (CMP_Positive_TypeDef)(CMP->CMP_CFG & (CMPX_CFG_CMPPS));
    }
    if (CMPx == CMP3) {
        ReadCMPPositive =
            (CMP_Positive_TypeDef)(CMP3->CMP_CFG & (CMP_CFG_CMPPS));
    }
    /* Get the CMP positive input channel type */
 ...
 *                  - CMP0_1_2NegativeSelect_CMPxN:Select CMPxN as the CMP0_1_2
 * Negative port
 *                  - CMP0_1_2NegativeSelect_DAC:Select DAC as the CMP0_1_2
 * Negative port
 *                  - CMP0_1_2NegativeSelect_BEMF_MID:Select BEMF_MID as the
 * CMP0_1_2 Negative port
 *                  - CMP3_NegativeSelect_CMPxN:Select CMPN as the CMP negative
 * input port
 *                  - CMP3_NegativeSelect_DAC:Select DAC as the CMP negative
 * input port
 *                  - CMP3_NegativeSelect_CMPRF:Select CMPRF as the CMP negative
 * input port
 * @retval None
 */
...
CMP_NegativeSelect_TypeDef CMP_GetNegativeSelection(CMP_TypeDef* CMPx)
{
    ...
    if (CMPx == CMP_0) {
        ...
        ReadCMPNegative =
            (CMP_NegativeSelect_TypeDef)(CMP->CMP_CFG & (CMPX_CFG_CMPNS));
    }
    if (CMPx == CMP_1) {
        /* Get the CMP1 positive input channel type */
        ReadCMPNegative =
            (CMP_NegativeSelect_TypeDef)(CMP->CMP_CFG1 & (CMPX_CFG_CMPNS));
    }
    if (CMPx == CMP_2) {
        /* Get the CMP2 positive input channel type */
        ReadCMPNegative =
            (CMP_NegativeSelect_TypeDef)(CMP->CMP_CFG2 & (CMPX_CFG_CMPNS));
    }
    if (CMPx == CMP3) {
        /* Get the CMP2 positive input channel type */
        ReadCMPNegative =
            (CMP_NegativeSelect_TypeDef)(CMP3->CMP_CFG & (CMP_CFG_CMPNS));
    }
    /* Get the CMP positive input channel type */
 ...
 *               - CMP_CMPSTA_Low:The non-inverting input is at a lower voltage
 * than the inverting input
 *               - CMP_CMPSTA_High: The non-inverting input is at a higher
 * voltage than the inverting input
 *               - CMP_CMP0STA_Low: The non-inverting input is at a lower
 * voltage than the inverting input
 *               - CMP_CMP0STA_High: The non-inverting input is at a higher
 * voltage than the inverting input
 *               - CMP_CMP1STA_Low	: The non-inverting input is at a lower
 * voltage than the inverting input
 *               - CMP_CMP1STA_High: The non-inverting input is at a higher
 * voltage than the inverting input
 *               - CMP_CMP2STA_Low: The non-inverting input is at a lower
 * voltage than the inverting input
 *               - CMP_CMP2STA_High: The non-inverting input is at a higher
 * voltage than the inverting input
 *               - CMP_CMP3STA_Low: CMP3 positive terminal voltage is less than
 * the negative terminal voltage
 *               - CMP_CMP3STA_High:The positive terminal voltage of CMP3 is
 * greater than the negative terminal voltage
 */
