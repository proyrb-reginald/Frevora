...
/** @defgroup VREF_Exported_Functions_Group1 Configuration of the vref
 ...
 *                  - Vref_InReferenceVoltageEx_2_048:VREF
 InReferenceVoltageEx 2.048
 *                  - Vref_InReferenceVoltageEx_1_024:VREF
 InReferenceVoltageEx 1.024
 *                  - Vref_InReferenceVoltageEx_2_4:VREF
 InReferenceVoltageEx 2.4
