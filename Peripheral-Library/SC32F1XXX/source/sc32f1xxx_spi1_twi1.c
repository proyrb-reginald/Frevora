...
/** @defgroup spi1_twi1_Group1 Configuration of the spi1_twi1 computation unit
functions
...
/**
 * @brief  DeInitialize the SPIx peripheral registers to their default reset
 values.
 ...
 * @param  SPI1_InitStruct[out]: Pointer to structure SPI1_InitTypeDef, to be
 * initialized.
 * @retval None
 */
...
/**
 * @brief  Initializes the peripheral SPIx register with the parameters
 * specified in SPI_InitStruct
...
void SPI1_Init(SPITWI_TypeDef* SPIx, SPI1_InitTypeDef* SPI1_InitStruct)
{
    ...
    if (SPIx == SPITWI_SPI1) {
        ...
        tmpreg &=
            (uint32_t)~(SPI1_CON_MSTR | SPI1_CON_SPMD | SPI1_CON_DORD |
                        SPI1_CON_CPHA | SPI1_CON_CPOL | SPI1_TWI1_CON_SPOS);
        /* Configure SPIx: mode, data size, first transmitted bit,clock
         * predivision , CPOL and CPHA */
        ...
        tmpreg |=
            (uint32_t)(SPI1_InitStruct->SPI1_Mode |
                       SPI1_InitStruct->SPI1_DataSize |
                       SPI1_InitStruct->SPI1_FirstBit |
                       SPI1_InitStruct->SPI1_CPHA | SPI1_InitStruct->SPI1_CPOL |
                       SPI1_InitStruct->SPI1_Prescaler);
 ...
 * @param  SPIx[out]:where can to select the SPI1 peripheral.
 *           - SPI1: select the SPI1 peripheral.
 * @param  SPI1_Mode[in]:specifies the data transfer direction in bidirectional
 * mode.
 ...
 * @param  SPIx[out]:where can to select the SPI1 peripheral.
 *           - SPI1: select the SPI1 peripheral.
 * @param  SPI1_IT[in]:specifies the SPI interrupts sources to be enabled or
 * disabled.
 ...
 * @param  TWI_InitStruct[out]: Pointer to structure TWI_InitTypeDef, to be
 * initialized.
 * @retval None
 */
...
/**
 * @brief  Initializes the peripheral TWIx register with the parameters
 * specified in TWI_InitStruct
...
void TWI1_Init(SPITWI_TypeDef* TWIx, TWI1_InitTypeDef* TWI_InitStruct)
{
    ...
    if (TWIx == SPITWI_TWI1) {
        ...
        tmpreg &= (uint32_t)~(TWI1_CON_AA | SPI1_TWI1_CON_QTWCK_Msk |
                              TWI1_CON_STRETCH | SPI1_TWI1_CON_MODE_Msk);
        ...
        tmpreg |= (uint32_t)(TWI_InitStruct->TWI1_Ack |
                             TWI_InitStruct->TWI1_Prescaler |
 ...
 * @param  TWI_Command[in]:specifies whether the TWI device will be a
 ...
 * @param  TWIx[out]:where can to select the TWI1 peripheral.
 *                  - TWI1:Timer peripheral select TWI1
 * @param  TWI1_IT[in]:specifies the TWI interrupts sources to be enabled or
 * disabled.
