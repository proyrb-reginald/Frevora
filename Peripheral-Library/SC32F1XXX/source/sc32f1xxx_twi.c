...
/**
 * @brief  DeInitialize the TWIx peripheral registers to their default reset
 * values.
...
void TWI_Init(TWI_TypeDef* TWIx, TWI_InitTypeDef* TWI_InitStruct)
{
    ...
    tmpreg |=
        (uint32_t)(TWI_InitStruct->TWI_Ack | TWI_InitStruct->TWI_Prescaler |
    ...
    /* Clear AA, TWCK, STRETCH bits */
    tmpreg &=
        (uint32_t)~(TWI_CON_AA | TWI_CON_SPOS | TWI_CON_STRETCH | TWI_CON_TWCK);
    /* Configure TWIx: Ack, Clock division and Slave Clock Stretch */
    /* Set AA bits to TWI_Ack value */
    /* Set TWCK bits according to TWI_DataSize value */
    /* Set STRETCH bit according to TWI_Stretch value */
 ...
 *                  SC32f10xx Selection
 * range(TWI0:TWI_PinRemap_Default,TWI_PinRemap_A - TWI_PinRemap_C
 *                                             TWI1:TWI_PinRemap_Default,TWI_PinRemap_A
 * - TWI_PinRemap_B) SC32f12xx Selection
 * range(TWI_PinRemap_Default,TWI_PinRemap_A - TWI_PinRemap_E) SC32f15xx
 ...
 *                  - TWI0:Timer peripheral select TWI0
 *                  - TWI1:Timer peripheral select TWI1
 * @param  TWI_IT[in]:specifies the TWI interrupts sources to be enabled or
 * disabled.
 ...
 *                         SC32f10xx Selection
 * range(TWI_FLAG_TWIF,TWI_FLAG_TXRXnE��TWI_FLAG_GCA,TWI_FLAG_MSTR) SC32f11xx
 * Selection range(TWI_FLAG_TWIF,TWI_FLAG_TXRXnE��TWI_FLAG_GCA,TWI_FLAG_MSTR)
 *                         SC32f12xx Selection
 * range(TWI_FLAG_TWIF,TWI_FLAG_TXRXnE��TWI_FLAG_GCA,TWI_FLAG_MSTR) SC32f15xx
 * Selection range(TWI_FLAG_TWIF,TWI_FLAG_TXRXnE��TWI_FLAG_GCA,TWI_FLAG_QTWIF)
