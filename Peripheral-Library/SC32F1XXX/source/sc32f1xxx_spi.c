 ...
 * @param  SPI_InitStruct[out]: Pointer to structure SPI_InitTypeDef, to be
 * initialized.
 * @retval None
 */
...
void SPI_Init(SPI_TypeDef* SPIx, SPI_InitTypeDef* SPI_InitStruct)
{
    ...
    /* Configure SPIx: mode, data size, first transmitted bit,clock predivision
     * , CPOL and CPHA */
    ...
    tmpreg |=
        (uint32_t)(SPI_InitStruct->SPI_Mode | SPI_InitStruct->SPI_DataSize |
    ...
    if (SPIx == SPI1) {
        ...
        /* Set SPR according to SPI0_Prescaler value */
        tmpreg |=
            (uint32_t)(((SPI_InitStruct->SPI_Mode |
 ...
 *           - SPI1: select the SPI1 peripheral.
 *           - SPI2: select the SPI2 peripheral.
 * @param  SPIMode[in]:specifies the data transfer direction in bidirectional
 * mode.
 ...
 *           - SPI1: select the SPI1 peripheral.
 *           - SPI2: select the SPI2 peripheral.
 * @param  SPI_IT[in]:specifies the SPI interrupts sources to be enabled or
 * disabled.
 ...
 *               - SPI_IT_TBIE��SPI Interrupt: Transmit TBIE under half
 * Interrupt
