...
void UART1_3_5_IRQHandler(void)
{
    ...
    UART_ClearFlag(
        UART1,
        UART_Flag_RX |
            UART_Flag_TX);  // Generated by EasyCodeCube, forbid editing!!!
}
#endif
...
{
    DMA_ClearFlag(DMA0,
                  DMA_FLAG_GIF | DMA_FLAG_TCIF | DMA_FLAG_HTIF | DMA_FLAG_TEIF);
...
void DMA1_IRQHandler(void)
{
    DMA_ClearFlag(
        DMA1,
        DMA_FLAG_GIF | DMA_FLAG_TCIF | DMA_FLAG_HTIF |
            DMA_FLAG_TEIF);  // Generated by EasyCodeCube, forbid editing!!!
    DMA_Buffer_Manager_IRQHandler(&DMA_Buffer_Manager_UART1);
}
