...
{
  GPIO_InitTypeDef GPIOInit_PB15_Struct;
  GPIOInit_PB15_Struct.GPIO_Pin = GPIO_Pin_15;
	...
	GPIO_Init(GPIOB,&GPIOInit_PB15_Struct);
}
...
{
  GPIO_InitTypeDef GPIOInit_PC03_Struct;
	...
	GPIO_Init(GPIOC,&GPIOInit_PC03_Struct);/*TxD0端口初始化*/
	...
	/*DMA_TX*/UART_DMACmd(UART0,UART_DMAReq_TX,ENABLE);
...
{
  GPIO_InitTypeDef GPIOInit_PB01_Struct;
